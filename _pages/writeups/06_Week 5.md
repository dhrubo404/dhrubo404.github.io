...
Where $\kappa_j \propto T_{\text{sys},j}^2$ is a hardware constant.
...
This defines the **feasible allocation set** $\mathcal{A} = \{S \subseteq \Omega : \text{Var}[\hat{y}_k](S) \leq \varepsilon_k^2 \; \forall k\}$.
